...
let tray;
let bookmarks = null;
const windowSize = { width: 420, height: 48};
...
app.on('ready', () => {
    app.dock.hide();
    globalShortcut.register('Cmd+Esc', () => mainWindow.isVisible() ? mainWindow.hide() : mainWindowShow(mainWindow));
    createWindow();
    ...
    const contextMenu = Menu.buildFromTemplate([
        {
            ...
            click() {
                mainWindow.isVisible() ? mainWindow.hide() : mainWindowShow(mainWindow);
            },
            accelerator: 'Cmd+Esc'
        },
        {
    ...
    if (isDev) {
        ...
        setTimeout(() => mainWindowShow(mainWindow), 500);
    }
});
app.on('activate', () => {
